...
CC=gcc
MD=mkdir
CFLAGS= -std=c11 -O3 # -fsanitize=address -m64 -Wformat=0 -Wno-unused-function -Wno-unused-result -D_FILE_OFFSET_BITS=64 -DDEBUG -D_DEBUG -pedantic
...
all: $(OBJ_dir) test40_005 test20_002
