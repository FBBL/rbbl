...
# source and objects
_SRC_files =  utils.c lwe_instance.c transition_times2_modq.c position_values_2_category_index.c transition_bkw_step_smooth_lms.c lookup_tables.c transition_bkw_step_final.c solve_fwht.c random_utils.c
SRC_files = $(patsubst %,$(SRC_dir)/%,$(_SRC_files))
OBJ_files = $(patsubst %.c,$(OBJ_dir)/%.o,$(_SRC_files))

all: $(OBJ_dir) test40_001 test20_005 test10_01
